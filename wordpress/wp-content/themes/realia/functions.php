...
function aviators_load_styles() {
    if (!is_admin()) {
        ...
        wp_register_style('fancybox', get_template_directory_uri() . '/assets/libraries/fancybox/source/jquery.fancybox.css');
        ...
        wp_register_script('chosen', get_template_directory_uri() . '/assets/libraries/chosen/chosen.jquery.min.js', array('jquery'), '', true);
        wp_register_script('fancybox', get_template_directory_uri() . '/assets/libraries/fancybox/source/jquery.fancybox.pack.js', array('jquery'), '', true);
...
function aviators_sidebars() {
    ...
    register_sidebar(array(
        ...
        'id' => 'navigation-right', 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h2>', 'after_title' => '</h2>', )
    );
    ...
    register_sidebar(array(
        ...
        'id' => 'property-detail', 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h2>', 'after_title' => '</h2>',
    ));
    ...
    register_sidebar(array(
        ...
        'id' => 'bottom-1', 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h2>', 'after_title' => '</h2>', )
    );

    register_sidebar(array(
        'name' => __('Bottom Two', 'aviators'),
        'id' => 'bottom-2', 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h2>', 'after_title' => '</h2>', )
    );

    register_sidebar(array(
        'name' => __('Bottom Three', 'aviators'),
        'id' => 'bottom-3', 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h2>', 'after_title' => '</h2>', )
    );
