WebMP.UserVisitorsController = Ember.ObjectController.extend(WebMP.Api, {
    needs: ['application'],
    ...
    dataUrl: function() {
        return WebMP.UrlManager.api.visitors(this.get('lastEntryDate'), this.get('isGalleryView'), this.get('isWithPictureOnly'), this.get('updateSettings'));
